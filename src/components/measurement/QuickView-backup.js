import { faArrowLeft, faArrowRight, faBagShopping, faCheck, faChevronDown, faClose, faEllipsis, faLock, faShop, faTape } from '@fortawesome/free-solid-svg-icons';
...
function QuickView({data, onQuickViewCloseClick}) {
    ...
    const [isTriedMeasure, setTriedMeasure] = useState(false);
    const [isFinishedMeasure, setFinishedMeasure] = useState(false);
    const [isStartedMeasure, setStartedMeasure] = useState(false);
    ...
    const handleCollapse = () => {
        ...
        setFinishedMeasure(false);
      };

    const handleStartedMeasure = () => {
        setStartedMeasure(true);
        setTriedMeasure(false);
        setFinishedMeasure(true);
    };
            ...
            {!isTriedItOn ? <>
                    ...
                    {isFinishedMeasure && (
                        <div className='d-flex justify-content-center align-items-center' id='body-obj'>
                            <OBJModel src="assets/obj/model.obj" texPath="./src/lib/model/" scale={{x:0.15,y:0.15,z:0.15}} position={{x:0,y:0.1,z:0}} width={560} height={766}>
                    ...
                    {isStartedMeasure && !isFinishedMeasure &&
                        <>
                            <DotLoader
                    ...
                    {isTriedMeasure && 
                        <div className='input-height-wrapper'>
                            <input type="text" className='input-height' name="height" id="height-input" value={height} 
                                placeholder="Please input height!" 
                                onChange={handleHeightChange} />
                            <button type='button' className='confirm-height' onClick={handleStartedMeasure}>
                    ...
                    <div className='action-buttons'>
                        <button type='button' className='button-long' onClick={() => setTriedMeasure(true)}>Measure</button>
...
const TriedItOnView = ({onCollapse, onChangeModel}) => {
    ...
    const slides = {
        women: [
            "https://doris-storage.imgix.net/production/a52e14cf-5fe1-465d-92b7-1e3d7dd206c9-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/0638d4ce-4454-46fc-84f9-3401b98bec63-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/7053e63d-a9fe-407f-bd4c-157abc99981c-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/a189627b-4909-4a02-bcfd-d1794d68ec87-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/26a4503e-5599-4e6b-a7dc-438b5b3bbe8d-avatar.jpg?w=572"
        ],
        men: [
            "https://doris-storage.imgix.net/production/a9f93b04-e268-4a24-9f8a-4cc7d0c763ad-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/6e0eb6e5-ddcd-4498-b5a8-215a2d6e47db-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/923ff5ee-2dd5-44b9-af0e-4aba1118108d-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/c0a0e949-90d9-4594-b167-ea4bd3b70829-avatar.jpg?w=572",
            "https://doris-storage.imgix.net/production/c651fb83-5784-49b6-81bd-b613c691c165-avatar.jpg?w=572"
        ]
    };

    const [slideSrc, setSlideSrc] = useState(slides['women']);
    ...
    const [gender, setGender] = useState(genderOpt[1]);
    
    useEffect(() => {
        console.log(gender);
        setSlideSrc(slides[gender.id])
    }, [gender])
    return (
        <div className='try-it-on-view'>
            ...
            >
                {curTab === 0 ?
                    <div className='try-me-wrapper'>
                        <div className='try-it-on-me'>
                            ...
                            <div className='try-me-bg'>
                                <img data-testid="instructional-card-image-0" src="https://media.doris.services/avatar-gallery.jpg" />
                            </div>
                            <h2 className="try-me-title">See how the clothes look on you</h2>
                            <div className='model-picker-wrapper'>
                                ...
                                />
                                <button type='button' className='confirm-model' onClick={() => onChangeModel(model)}>
                                <FontAwesomeIcon icon={faCheck} color='#000' size='xl' />
                            </button>   
                            </div>
                 ...
                 : 
                 <div className='try-it-on-model'>
                    <div className='gender-select-container'>
                        <div className='gender-select'>
                            <p>Select gender</p>
                            <Select options={genderOpt} multi={false} values={[gender]} className='gender-select-style' onChange={(value) => setGender(value[0])}></Select>
                        </div>
                    </div>
                    <CustomSwiper
                        slidesPerView={1.3}
                        ...
                        isPagination={true}
                    >
                        {slideSrc?.map((item, idx) => <SwiperSlide>
